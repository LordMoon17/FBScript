...
if getgenv().KatakuriAttackRunning then
    return
end

getgenv().KatakuriAttackRunning = true

task.spawn(function()
    local nextAbilityTimes = {}
    local nextM1Cycle = 0

    while getgenv().KatakuriFarmEnabled and getgenv().KatakuriAttackRunning do
...
print("Ataque a Katakuri activado")
