...
if getgenv().CakeQueenBugRunning then
    return
end

getgenv().CakeQueenBugRunning = true
...
task.spawn(function()
    for press = 1, 4 do
        ...
        if not ok then
            ...
            getgenv().CakeQueenBugRunning = false
            return
        end

        print("Cake Queen Drums " .. press .. "/4")
    ...
    getgenv().CakeQueenGear5Ready = true
    print("Gear5 para Cake Queen activado, reiniciando...")
